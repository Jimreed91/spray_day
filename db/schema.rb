...
ActiveRecord::Schema.define(version: 2022_08_06_135437) do
  ...
  create_table "program_crops", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["crop_id", "spray_program_id"], name: "index_program_crops_on_crop_id_and_spray_program_id", unique: true
  ...
  create_table "program_doses", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_id", "spray_program_id"], name: "index_program_doses_on_product_id_and_spray_program_id", unique: true
  ...
  create_table "program_sprayers", force: :cascade do |t|
    ...
    t.index ["sprayer_id", "spray_program_id"], name: "index_program_sprayers_on_sprayer_id_and_spray_program_id", unique: true
